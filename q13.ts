...
let transportation:string[]=["helicopter","sumbrine","car"];
console.log(`i would like to own a ${transportation[1]}`);
console.log(`i would travel through ${transportation[0]}`);
console.log(`go to university through ${transportation[2]}`);